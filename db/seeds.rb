...
user_16 = User.create(name: "EmilyBen")
user_15 = User.create(name: "LadyBird")

user_1.reviews.create(title: "Great Read!", description: "Wow!! Pleasantly surprised.", rating: 5, book: book_1, created_at: 4.days.ago)
user_14.reviews.create(title: "He's the best", description: "I never miss one of his books", rating: 5, book: book_1, created_at: 9.days.ago)
...
user_2.reviews.create(title: "Intense", description: "I cried...hard.", rating: 4, book: book_2, created_at: 4.days.ago)
user_1.reviews.create(title: "Hot Takes", description: "The best.", rating: 5, book: book_2, created_at: 9.days.ago)
...
user_2.reviews.create(title: "Amazing", description: "Dumbfounded", rating: 5, book: book_3, created_at: 9.days.ago)
user_1.reviews.create(title: "fun-ish", description: "surprising in every way", rating: 4, book: book_3, created_at: 4.days.ago)
...
user_8.reviews.create(title: "That's a Maybe", description: "tough sell", rating: 3, book: book_4, created_at: 9.days.ago)
...
user_12.reviews.create(title: "Meh", description: "probably not going to read again!", rating: 2, book: book_4, created_at: 4.days.ago)
...
user_2.reviews.create(title: "Platinum", description: "so close to reality, I can touch it!!!", rating: 5, book: book_5, created_at: 9.days.ago)
...
user_8.reviews.create(title: "too young to enjoy", description: "needed more explosions", rating: 2, book: book_5, created_at: 4.days.ago)
...
user_13.reviews.create(title: "Too Funny...", description: "almost lost bowels reading this...", rating: 5, book: book_6, created_at: 9.days.ago)
user_15.reviews.create(title: "still don't know who Biff is...", description: "tried too hard to be funny", rating: 3, book: book_6, created_at: 4.days.ago)
...
user_1.reviews.create(title: "what a coincidence", description: "I think I might know this guy!", rating: 5, book: book_7, created_at: 9.days.ago)
user_10.reviews.create(title: "can't wait for the next one...", description: "love the writing here, a good read for the parents too!", rating: 5, book: book_7, created_at: 4.days.ago)
...
user_6.reviews.create(title: "Fell Out of My Chair", description: "can someone please help me, I've fallen and I can't get up", rating: 3, book: book_8, created_at: 4.days.ago)
user_12.reviews.create(title: "to the person above", description: "Do you need any ambulance? ", rating: 3, book: book_8, created_at: 9.days.ago)
...
user_3.reviews.create(title: "White hot", description: "A devastating debut nobvel.  Masterful.", rating: 4, book: book_9, created_at: 9.days.ago)
user_4.reviews.create(title: "Gripping", description: "Deep dive into urban indigenous life.", rating: 3, book: book_9)
user_11.reviews.create(title: "can't sleep", description: "Went further than I'd expected from Orange.", rating: 4, book: book_9, created_at: 4.days.ago)
...
user_11.reviews.create(title: "Majestic", description: "Just finished, and I want to beat my chest across the sun!!", rating: 3, book: book_10, created_at: 4.days.ago)
user_5.reviews.create(title: "Good Read", description: "Just enough for the city.", rating: 3, book: book_10, created_at: 9.days.ago)
...
user_3.reviews.create(title: "Not bad", description: "I didn't read the whole thing ", rating: 2, book: book_11, created_at: 9.days.ago)
user_13.reviews.create(title: "What a Read", description: " litterally sitting at the edge of my seat!", rating: 5, book: book_11)
user_5.reviews.create(title: "Please Purchase", description: "wow is all all can say about this riviting story.", rating: 4, book: book_11, created_at: 4.days.ago)
...
user_7.reviews.create(title: "Boom", description: "crazy good", rating: 5, book: book_12, created_at: 9.days.ago)
...
user_15.reviews.create(title: "The Ending!!!", description: "skip to the end before reading the beginning! Pro Tip for this one", rating: 5, book: book_12, created_at: 4.days.ago)
...
user_12.reviews.create(title: "Weird", description: "don't get it", rating: 2, book: book_13, created_at: 9.days.ago)
...
user_8.reviews.create(title: "unlike you guy's", description: "I though my cousin's book... I mean their writing was the best I've seen in years", rating: 5, book: book_13, created_at: 4.days.ago)
...
user_2.reviews.create(title: "nah", description: "too much Shakespeare", rating: 2, book: book_14, created_at: 9.days.ago)
user_16.reviews.create(title: "welp, I lost a brain cell", description: "I've heard this same story time and time again.", rating: 3, book: book_14)
...
user_4.reviews.create(title: "gratted cheese", description: "read it all before, would like to hear more from this author though", rating: 3, book: book_14, created_at: 4.days.ago)
...
user_12.reviews.create(title: "Funny!", description: "unexpected!", rating: 4, book: book_15, created_at: 9.days.ago)
user_3.reviews.create(title: "Fun!", description: "great!", rating: 4, book: book_15)
user_13.reviews.create(title: "considerably lost", description: "hummor was strange, but once you get the hang of it, great read", rating: 4, book: book_15)
user_16.reviews.create(title: "makes me want to dance", description: "The way Carol and Diane dance with the cute twin brothers... ugh so jealous", rating: 4, book: book_15, created_at: 4.days.ago)
user_4.reviews.create(title: "I feel like the fool", description: "come on guys, you just like the author because he looks better than Steven Segal, my hero", rating: 2, book: book_15)
user_5.reviews.create(title: "Will Read Again", description: "The ending was perfection", rating: 4, book: book_15)
